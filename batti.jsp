...
<title>View Movie  Description</title>
</head>
<body class="body1">
<div>
...
<div class=text2>
 ...
 System.out.println("aaaaa"+request.getQueryString());
 ResultSet rs=st.executeQuery("Select * from movie_list where movie_name='"+request.getQueryString()+"'");			
 if(rs.next())
 {                   
 %>
<img src="getImage.jsp?id=<%=rs.getString(1)%>" height="300" width="300"></img>
</div>
		...
		<tr>
			...
			<input type="radio" name="index" value=<%=k %> required><br>
				...
				<%
					...
					{     System.out.println("w"+at.get(k).getLocation());
					      System.out.println("ww"+al.get(k).getLocation()); 
...
Released Date: <%=rs.getString("release_date")%>
</aside></p></p>
<%}%>
</body>
</html>