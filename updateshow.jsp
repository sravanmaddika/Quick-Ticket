...
<center>
	<form action="UpdateServlet" method="post">
		<table height="450">
                     <h2 align="center">Update Show Information</h2> 
			...
			<tr>		
				...
				<td>		
					<input type="date" name="osdate" style="width: 200px;"/>
				</td>
			</tr>
			<tr>		
				<td>
				...
				<td>		
					<input type="date" name="nsdate" style="width: 200px;"/>
				</td>
			</tr>
			<tr>
				<td>		
				...
				<td>
					<input type="time" name="ostime" style="width: 200px;"/>
				</td>
			</tr>
			<tr>
				<td>		
				...
				<td>
					<input type="time" name="nstime" style="width: 200px;"/>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<select name="osno" style="width: 200px;">
                                        <option>1</option>
			...
			<tr>
				...
				<td>
					<select name="nsno" style="width: 200px;">
                                        <option>1</option>
                                         <option>2</option> <option>3</option>
                                          <option>4</option>
                                           <option>5</option>
