...
<nav class="navbar navbar-light">  <div class="container-fluid">
	...
	<form action="MovieServlet" method="post">
		<table height="350">
                    <h2 align="center">Upload New Movie</h2> 
			...
			<tr>
				...
				<td>	
					<input type="text" name="mname" style="width: 200px;"/>
				</td>
			...
			<tr>		
				...
				<td>		
					<input type="date" name="rdate" style="width: 200px;"/>
				</td>
			</tr>
			<tr>
				<td>		
			...
			<tr>
				...
				<td>
					<input type="text" name="tname" style="width: 200px;"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type=file name="imagelogo" style="width: 200px;"/>
				</td>
			</tr>
                        <tr>
				<td>
